...
Welcome to [prathimacode-hub/Treksy](https://github.com/prathimacode-hub/Treksy/). Before sending your pull requests, make sure that you **read the whole
...
* Step 2: Add a upstream link to main branch in your cloned repo
    ```
    git remote add upstream https://github.com/prathimacode-hub/Treksy.git
    ```
* Step 3: Keep your cloned repo upto date by pulling from upstream (this will also avoid any merge conflicts while committing new changes)
    ```
    git pull upstream main https://github.com/prathimacode-hub/Treksy.git
    ```
...
4. Participants / contributors can also **open their issues** using [issue_template](https://github.com/prathimacode-hub/Treksy/tree/main/.github/issue_template),
...
- Do not update the [README.md](https://github.com/prathimacode-hub/Treksy/blob/main/README.md) and [Contributing_Guidelines.md](https://github.com/prathimacode-hub/Treksy/blob/main/CONTRIBUTING.md)
